...
module.exports = function (app, pool, requireAuth, requireRole) {
  ...
  async function buildSummary(q) {
    ...
    return {
      period: period, orgs: orgs, value_tier: valueTier, low_value: lowValue, low_value_by_customer: lowValueByCustomer,
      redelivery: redelivery, drops: drops, rejection_redelivery: rejectionRedelivery,
