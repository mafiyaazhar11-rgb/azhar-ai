...
app.get('/api/returns/export-excel', requireAuth, async function(req, res) {
  try {
    ...
    rows.forEach(function(r) {
      ...
      if (r.month) {
        if (!monthAgg[r.month]) monthAgg[r.month] = { food: 0, nonfood: 0, zooz: 0, total: 0, foodOrd: 0, nfOrd: 0, zoozOrd: 0, totalOrd: 0 };
    ...
    mtFullMonths.forEach(function(m, mi) {
      ...
      var ma = monthAgg[m] || { food: 0, nonfood: 0, zooz: 0, total: 0, foodOrd: 0, nfOrd: 0, zoozOrd: 0, totalOrd: 0 };
