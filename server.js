...
async function buildCustomerBreakdown(name) {
  ...
  var acc = {};
  BUCKETS.forEach(function(b) { acc[b] = { rejected: 0, valueAtRisk: 0, foodCount: 0, nonfoodCount: 0, byOrg: {}, byMonth: {}, byMonthOrg: {}, byRoot: {}, byRootOrg: {}, recent: [] }; });
  ...
  function finalizeBucket(b) {
    ...
    var orgList = Object.keys(orgKeys).map(function(k) {
      ...
      return { org: k, rejected: o.rejected, delivered: deliveredByOrg[k] || 0, value: o.value };
    ...
    return {
      ...
      byMonth: monthList,
      rootCauses: rootList.slice(0, 15),
...
app.get('/api/rejection/customer-export-excel', requireAuth, async function(req, res) {
  try {
    ...
    bw.columns = [{ width: 16 }, { width: 16 }, { width: 16 }, { width: 20 }];
