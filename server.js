...
app.get('/api/rejection/customer-export-excel', requireAuth, async function(req, res) {
  try {
    ...
    b.byOrg.forEach(function(o) { bw.addRow([o.org, o.rejected, o.delivered, Math.round(o.value || 0)]); });
    var bwTotal = bw.addRow(['TOTAL', b.byOrg.reduce(function(s, o) { return s + o.rejected; }, 0), b.byOrg.reduce(function(s, o) { return s + o.delivered; }, 0), Math.round(b.byOrg.reduce(function(s, o) { return s + (o.value || 0); }, 0))]);
    styleTotalRow(bwTotal);
    bw.addRow([]);
    bw.addRow([]);
    var bwOrgsWithRejections = b.byOrg.filter(function(o) { return o.rejected > 0; }); // already sorted highest rejection first
